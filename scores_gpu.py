...
# 1. Device Setup and Verification
...
if device == "cuda":
    ...
    print("WARNING: PyTorch cannot detect a GPU. Ensure CUDA-enabled PyTorch is installed.")

import evaluate
from comet import download_model, load_from_checkpoint

INPUT_FOLDER = "fs/gpt-oss-20b"
...
# Pass device explicitly to BERTScore
...
# Ensure COMET model itself is on GPU if available
if device == "cuda":
    comet_model.to("cuda")
