...
MODEL_FILE_MAP = {
    ...
    "Qwen3 DGT (sa-en-hi)": "combined/seh/qwen3_4b_instruct_scores.jsonl",
    "Qwen3 DGT (sa-hi)": "combined/sh/qwen3_4b_instruct_scores.jsonl",
    "Qwen3 DGT (sa-hi-en)": "combined/she/qwen3_4b_instruct_scores.jsonl",    
}
