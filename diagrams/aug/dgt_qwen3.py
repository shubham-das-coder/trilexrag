...
MODEL_FILE_MAP = {
    "DGT (sa-en)": "combined/se/qwen3_4b_instruct_scores.jsonl",
    "DGT (sa-en-hi)": "combined/seh/qwen3_4b_instruct_scores.jsonl",
    "DGT (sa-hi)": "combined/sh/qwen3_4b_instruct_scores.jsonl",
    "DGT (sa-hi-en)": "combined/she/qwen3_4b_instruct_scores.jsonl",    
}
...
Y_AXIS_LABEL = "Qwen3-4B"
OUTPUT_DIR = "diagrams/aug/dgt-qwen3"
