...
# -----------------------------
# Convert to (100 - value)
# -----------------------------

converted_data = {
    dataset: [100 - v for v in values]
    for dataset, values in data.items()
}

# Create DataFrame
df = pd.DataFrame(converted_data, index=models)
...
png_path = "diagrams/num_hal.png"
pdf_path = "diagrams/num_hal.pdf"
...
pptx_path = "diagrams/num_hal.pptx"
ppt.save(pptx_path)
